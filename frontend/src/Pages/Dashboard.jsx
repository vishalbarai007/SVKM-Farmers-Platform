...
const Dashboard = () => {
  ...
  return (
    <div className=" min-h-screen flex flex-col lg:flex-row">
      ...
      {user ? (<div className="lg:w-1/4 p-6 bg-gray-900 rounded-lg shadow-lg text-white flex flex-col items-center lg:items-start">
        <div className="flex flex-col lg:flex-row items-center lg:items-start mb-8">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-semibold text-gray-100">{user.displayName}</h2>
      ...
      </div>) : (<div className="lg:w-1/4 p-6 bg-gray-900 rounded-lg shadow-lg text-white flex flex-col items-center lg:items-start">
        <div className="flex flex-col lg:flex-row items-center lg:items-start mb-8">
          <img
